...
class PathDataProcessor(ABCDataProcessor):
    ...
    def process_record(self, record_index: int,
        ...
        if any([(keep_keys and not self.record_filter(indexed_nodes, keep_keys, regex=regex)),
    ...
    def process_page(self,
        ...
        for path in self.path_node_index.index.values():
            self.process_record(path.record_index,
                                keep_keys = keep_keys,
