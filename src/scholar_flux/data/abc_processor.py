...
This module defines the abstract methods and types that each processor
will use for compatibility with the SearchCoordinator in the processing
step.
"""
...
class ABCDataProcessor(ABC):
    ...
    def process_record(self, *args, **kwargs) -> Optional[dict]:
        ...
        Used extract record data and article content, creating a
        processed record dictionary with an abstract field.
        """
        pass
    ...
    def __repr__(self) -> str:
        ...
        Useful for showing the options being used to process the records
        that originate from the parsed api response.
        """
