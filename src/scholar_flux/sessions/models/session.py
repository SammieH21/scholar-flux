...
class BaseSessionManager(ABC):
    ...
    This base class can be extended to validate inputs to sessions and
    abstract the complexity of their creation
    """
    ...
    def get_cache_directory(cls, *args, **kwargs) -> Optional[Path]:
        ...
        Can be optionally overridden in the creation of cached session
        managers
        """
    ...
    def __call__(self) -> requests.Session | requests_cache.CachedSession:
        ...
        Calls the self.configure_session() method to return the created
        session object.
        """
...
class CachedSessionConfig(BaseModel):
    ...
    This config is used to validate the inputs to the session manager
    prior to attempting its creation.
    """
    ...
    def validate_backend_dependency(cls, v):
        ...
        If the backend has unmet dependencies, this validator will
    ...
    def cache_path(self) -> str:
        ...
        Assumes that the cache_name is provided to the config is not
        `None`.
        """
