...
BaseSessionManager abstract base class that are key building blocks in the creation of new sessions.

Classes:
    BaseSessionManager: Defines the core, abstract methods necessary to create a new session object from session
                        manager subclasses.
    CachedSessionConfig: Defines the underlying logic pessary to validate the configuration used when creating CachedSession
