...
class InMemoryStorage(ABCStorage):
    ...
    """
    def __init__(self, namespace: Optional[str] = None, ttl: Optional[int] = None, **memory_config) -> None:
        """
    ...
    def retrieve_all(self) -> Optional[Dict[str,Any]]:
        ...
        return {k: v for k, v in self.memory_cache.items()
    ...
    def delete_all(self) -> None:
        ...
        try:
            ...
            if not self.namespace:
                ...
                filtered_cache = {k: v for k, v in self.memory_cache.items()
