...
scholar_flux implements the ABCStorage with subclasses for SQLite
(through SQLAlchemy), Redis, MongoDB, and In-Memory cache and can be
further extended to duckdb and other abstractions supported by
SQLAlchemy.
"""
...
class ABCStorage(ABC):
    ...
    This subclass provides methods to check the cache, delete from the
    cache, update the cache with new data, and retrieve data from the
    cache storage.
    """
    ...
    def __deepcopy__(self, memo) -> Self:
        ...
        This method defines the error message that will be used by
        default upon failures.
        """
    ...
    def __repr__(self) -> str:
        ...
        Useful for showing the options being used to store and retrieve
