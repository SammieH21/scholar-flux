...
class MongoDBStorage(ABCStorage):
    ...
    def clone(self) -> MongoDBStorage:
        ...
        Note that the implementation of the MongoClient is not able to be deep copied. This method is provided
        for convenience for re-instantiation with the same configuration.
        """
        cls = self.__class__
