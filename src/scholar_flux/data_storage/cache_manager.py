...
class DataCacheManager:
    ...
    def __init__(self, cache_storage: Optional[BaseStorage] = None) -> None:
        self.cache_storage = cache_storage or BaseStorage()
    ...
    def verify_cache(self, cache_key: str) -> bool:
        ...
        if cache_key is None:
            ...
            return False
        if cache_key in self.cache_storage.retrieve_keys():
    ...
    def cache_is_valid(self, cache_key: str, response: Response) -> bool:
        ...
        cached_response = self.cache_storage.retrieve(cache_key) or {}
