...
This class is the user-interface that implements a unified interface for
different cache storage devices that inherit from the ABCStorage class.
"""
...
class DataCacheManager:
    ...
    def __deepcopy__(self, memo) -> DataCacheManager:
        ...
        Note that many clients cannot be directly deep-copied, and as a
        result, this implementation uses `clone` instead to create a new
        instance with a similar configuration. For easier API
        compatibility
        """
        return self.clone()
    ...
    def __repr__(self) -> str:
        ...
        This class will indicate the current cache storage device that
        is being used for data caching.
        """
