...
The PathSimplifier will return the full paths to arrive at each path if
allowed. Otherwise, the PathSimplifier will attempt to shorten the names
in the final dictionary of paths up to the user-specified nested key
