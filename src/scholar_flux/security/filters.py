...
This module uses the `SensitiveDataMasker` class to flag and redact text
prior to it ever reaching the console or file via the `logging` module.
"""
import logging
...
class MaskingFilter(logging.Filter):
    ...
    def filter(self, record) -> bool:
        ...
        This class will always return True after an attempt to mask
        sensitive fields is completed.
        """
        if record.args:
