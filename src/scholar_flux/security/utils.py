...
This class uses the pydantic.SecretStr class to mask and unmask fields
and can be further extended to encrypt and decrypt text as needed before
and after conversion to a secret string, respectively.
"""
...
class SecretUtils:
    ...
    Class methods are defined so that they can be used directly or
    implemented as a mixin so that subclasses can implement the class
    methods directly.
    """
