...
validating and preparing lists and iterables of page numbers for the iterative multi-page retrieval when using the
`SearchCoordinator.search_pages` method."""
...
class PageListInput(RootModel[Sequence[int]]):
    ...
    a list, string, or generator that contains at least one page. If a singular integer is received, the result is
