...
class SearchResult(BaseModel):
    ...
    def __len__(self) -> int:
        ...
        If the received Response was an ErrorResponse or NoneType
        object, then this value will be 0, indicating that no records
    ...
    def response(self) -> Optional[Response | ResponseProtocol]:
        ...
        If the received response is not available (None in the
        response_result), then this value will also be absent (None).
        """
        return (
    ...
    def parsed_response(self) -> Optional[Any]:
        ...
        If an ErrorResponse was received instead, the value of this
        property is None.
        """
    ...
    def processed_records(self) -> Optional[list[dict[Any, Any]]]:
        ...
        If an error response was received instead, the value of this
        property is None.
        """
    ...
    def data(self) -> Optional[list[dict[Any, Any]]]:
        ...
        Contains the processed records from the APIResponse processing
        step after a successfully received response has been processed.
        If an error response was received instead, the value of this
        property is None.
        """
    ...
    def cache_key(self) -> Optional[str]:
        ...
        This cache key is used when storing and retrieving data from
