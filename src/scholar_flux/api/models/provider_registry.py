...
When scholar_flux uses a provider_name to create a SearchAPI or
SearchCoordinator, the package-level provider_registry is instantiated
and referenced to retrieve the necessary configuration for easier
...
class ProviderRegistry(UserDict[str, ProviderConfig]):
    ...
    def get_from_url(self, provider_url: Optional[str]) -> Optional[ProviderConfig]:
        """Attempt to retrieve a ProviderConfig instance for the given provider by resolving matching an url to the
