...
This class is implemented by default within the `SearchCoordinator`
class to verify and retry each request until successful or the maximum
...
class RetryHandler:
    ...
    def __repr__(self) -> str:
        ...
        This method will show the name of the class in addition to the
