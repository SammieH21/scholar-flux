# /api/providers
"""The scholar_flux.api.providers module contains the pre-defined config
settings that are used to make a set of API providers available by default. The
module was designed for extensibility to enable the addition of new providers
