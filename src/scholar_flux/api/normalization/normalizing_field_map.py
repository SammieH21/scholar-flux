...
class NormalizingFieldMap(BaseFieldMap):
    ...
    def normalize_record(
        self, record: RecordType, include_api_specific_fields: Optional[bool | Sequence[str]] = True
        ...
        return self.filter_api_specific_fields(post_processed_record, include_api_specific_fields)
    ...
    def normalize_records(
        ...
        return [
            self.filter_api_specific_fields(
                self._post_process(normalized_record), include_api_specific_fields=include_api_specific_fields
            )
