...
class PubMedFieldMap(AcademicFieldMap):
    ...
    @staticmethod
    def extract_doi(record: NormalizedRecordType) -> Optional[str]:
        ...
        if doi := PubMedFieldMap._extract_article_id(record, "doi"):
            return doi
    ...
    @staticmethod
    def extract_open_access(record: NormalizedRecordType) -> Optional[bool]:
