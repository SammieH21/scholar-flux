...
def validate_bool_str(
    ...
    Args:
        ...
        default (Optional[bool]):
            An optional default to use when a true value cannot be found in a valid string (default=False). Some
            applications may warrant returning `None` instead of `False` when a `True` value is not identified.
