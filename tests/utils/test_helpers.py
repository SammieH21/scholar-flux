...
@pytest.fixture()
def new_tuple() -> tuple:
    """Helper class for verifying whether new classes are sucessfully renamed"""
    return (4, 5, 6)

@pytest.fixture()
def new_fn() -> Callable:
    """Creates a helper function to test whether `set_public_api_module` successfully renames function modules"""
    def a_fn():
