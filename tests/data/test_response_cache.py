...
def test_response_cache(
    academic_json_response, db_dependency_unavailable, request, cache_backend, cache_kwargs, cache_requests
):
    ...
    search_coordinator = SearchCoordinator(
        api, cache_manager=storage_cache, use_cache=cache_requests, processor=RecursiveDataProcessor()
    )
