...
def test_response_cache(
    mock_academic_json_response, redis_dependency, mongodb_dependency, sqlalchemy_dependency, sqlite_db_url
):
    ...
    search_coordinator = SearchCoordinator(
        api, session=redis_session, cache_manager=storage_cache, processor=RecursiveDataProcessor()
    )
