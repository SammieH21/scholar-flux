...
def test_recursive_processor(sample_json):
    ...
    flattened_process = [processor.recursive_processor.process_and_flatten(data ) for data in processor.json_data] if processor.json_data else None
