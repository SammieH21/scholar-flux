...
def test_match(provider, expected_type):
    ...
    This test uses the parametrize decorator from pytest to iteratively
    verify whether each attribute is a `ProviderConfig` typed variable
    or `None` based on the provider name and its expected_type inputs.
    """
