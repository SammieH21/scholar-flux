...
def plos_page_1_data() -> list | dict:
    """The data to return when simulating the retrieval of page 1 data from the PLOS API with the current query and
    requests_mock."""
...
def plos_page_2_data() -> list | dict:
    """The data to return when simulating the retrieval of page 2 data from the PLOS API with the current query and
    requests_mock."""
