...
def mock_cache_storage_data() -> dict[str, Any]:
    """Mocks the creation of processed data that is stored for later retrieval after response retrieval/processing when
    processed response caching is enabled."""
    return {
...
def mock_academic_json_path() -> Path:
    """The path where the data is stored to simulate the retrieval/processing of JSON data from an academic response
    API."""
